#include "path_planner/BlueBinDetector.h"


BlueBinDetector::BlueBinDetector()
{
    sobelThresholdX = 35;
    sobelThresholdY = 35;
    morph_size = 1;
...
bool BlueBinDetector::detectGate(Mat orig)
{
...
//    inRange(frame,Scalar(100,150,0),Scalar(140,255,255),thresh); // Blue simulator
...
double BlueBinDetector::dist(Point p1,Point p2)
{
